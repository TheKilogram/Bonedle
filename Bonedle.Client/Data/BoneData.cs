    ...
    public static List<Bone> GetAdditionalFullBones()
    {
        ...
        return new List<Bone>
        {
            ...
            new("talus-left", "Talus (Left)", "appendicular", "foot", "short", 1,
                new List<string> { "tibia-left", "fibula-left", "calcaneus-left", "navicular-foot-left" }, false, 42, 91),
            ...
            new("talus-right", "Talus (Right)", "appendicular", "foot", "short", 1,
                new List<string> { "tibia-right", "fibula-right", "calcaneus-right", "navicular-foot-right" }, false, 58, 91),
